...
namespace Лаб83 {
	...
	private: void Enemy_Taking_turn() {
		if (pass_you = 1 && score_enemy <= score_you) {
			if (score_enemy <= 17) {
				Card^ current_card;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label_pass_enemy->Location = System::Drawing::Point(662, 136);
			...
			this->label_pass_you->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 18, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label_pass_you->Location = System::Drawing::Point(662, 444);
